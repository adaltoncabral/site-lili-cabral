...
// Dados movidos para um arquivo separado (simulado aqui para fins de exemplo)
const APP_DATA = {
  banners: [
  ...
  contact: {
    ...
    instagram: 'lilicabral' // Substituir pelo Instagram real
  }
};

// Componentes de Ícones (melhorados com acessibilidade)
          ...
          renderItem={(banner, index, isActive) => (
            <div className="absolute inset-0">
              <Image 
                ...
                priority={index === 0} // Pré-carrega o primeiro banner
              />
